   ...
   /* ajax("./README.md", function (res) {
    ...
    SmohanMusic.prototype = {
        ...
        createListDom : function(){
            var i = 0, ul = '<ul style="padding-left:0px">';
            for(i;i<this.musicLength;i++){
                ul += '<li class="f-toe">'+
                			'<strong style="width:5%;display:inline-block">'+(i+1)+'、</strong>'+
                			'<strong style="width:35%;display:inline-block">'+this.musicList[i]['title']+'</strong>'+
                			'<strong style="width:30%;display:inline-block">'+this.musicList[i]['singer']+'</strong>'+
                			'<strong style="width:30%;display:inline-block">'+this.musicList[i]['type']+'</strong>'+
                	   '</li>';
            }
            ul += '</ul>';
